...
if (isset($_GET['status'])) {
    if ($_GET['status'] == 'success') {
        echo "<script>alert('Data Fasilitas Umum Tersimpan');</script>";
...
<head>
    <meta charset="UTF-8">
    <title>Input Fasilitas Umum</title>
    ...
    <div class="row">
        <div class="col-lg-10 ms-auto">
            <div class="form-container">
                <h3 class="text-center mb-4 mt-3">Input Fasilitas Umum</h3>
                <div class="form-input">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="backend/input_fasilitas_umum.php" enctype="multipart/form-data">
                                <table class="table">
                                    <tr>
                                        <td>Nama Fasilitas</td>
                                        <td><input type="text" required="required" name="nama_fasilitas"
                                                class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Deskripsi</td>
                                        <td><textarea name="deskripsi" required="required"
